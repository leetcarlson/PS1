...
$mails = Get-MailboxItem -Verbose -UserMailAddress "username@iu.edu"
$mails | Select-Object -Property:From,DateTimeReceived,Subject,isread | where-object -Property:isread -eq $false

This will get all messages that are unread.
