...
$ostfile = get-item 'C:\users\lcarlson\Local Settings\Application Data\Microsoft\Outlook\lcarlson@iu.edu - outlook.ost'

#$ActualSize = ([math]::Round(($ostfile.Length / 1MB)))

Format-Disksize $ostfile.Length